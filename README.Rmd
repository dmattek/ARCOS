...
**A**utomated **R**ecognition of **Co**llective **S**ignalling (ARCOS) is an [R](https://www.r-project.org) package to identify space-time correlations in biological data. The associated publication in the Journal of Cell Biology is available [here](https://doi.org/10.1083/jcb.202207048).
...
Please visit the main ARCOS project page for general documentation and installation instructions [gitbook](https://arcos.gitbook.io/home/).
