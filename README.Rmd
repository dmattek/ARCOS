...
- Python implementation, [arcos4py](https://github.com/bgraedel/arcos4py) written by Benjamin Grädel.
- A plugin with GUI for [napari](https://napari.org) image viewer, [arcos-gui](https://github.com/bgraedel/arcos-gui) written by Benjamin Grädel. See a YouTube [demo](https://www.youtube.com/watch?v=hG_z_BFcAiQ).
