...
**A**utomated **R**ecognition of **Co**llective **S**ignalling (ARCOS) is an [R](https://www.r-project.org) package to identify space-time correlations in biological data.
...
Documentation for the entire ARCOS project on [gitbook](https://arcos.gitbook.io/home/).
