...
```{r, echo = T, fig.width=5, fig.height=5, caption="Visualisation of object traces over time"}
...
knitr::kable(head(ARCOS::keepSignifDig(dts2, 4)))
```
...
knitr::kable(head(ARCOS::keepSignifDig(dcoll2, 4)))
```
