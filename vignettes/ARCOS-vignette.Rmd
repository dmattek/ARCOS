...
ARCOS stands for **A**utomatic **R**ecognition of **Co**llective **S**ignalling. The package implements the algorithm for identification and tracking of spatially clustered objects in time series data. It works with 1-, 2-, and 3D geometries. 
